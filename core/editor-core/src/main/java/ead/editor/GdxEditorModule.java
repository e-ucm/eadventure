...
public class GdxEditorModule extends AbstractModule {
	...
	protected void configure() {
		...
		map.getBinds().put(AssetHandler.class, GdxEditorAssetHandler.class);
		map.getBinds().put(GdxAssetHandler.class, GdxEditorAssetHandler.class);
		for (Map.Entry<Class<?>, Class<?>> entry : map.getBinds().entrySet()) {
