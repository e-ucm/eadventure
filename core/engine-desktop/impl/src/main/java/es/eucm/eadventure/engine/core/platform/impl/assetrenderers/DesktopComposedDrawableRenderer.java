...
@Singleton
public class DesktopComposedDrawableRenderer implements AssetRenderer<Graphics2D, RuntimeComposedDrawable> {

	/**
	 * Logger
	 */
	private static final Logger logger = LoggerFactory.getLogger(DesktopComposedDrawableRenderer.class);
	...
	@Inject
	public DesktopComposedDrawableRenderer(AssetHandler assetHandler, GraphicRendererFactory<?> rendererFactory) {
