...
import es.eucm.eadventure.engine.core.platform.impl.assetrenderers.DesktopIrregularShapeRenderer;
import es.eucm.eadventure.engine.core.platform.impl.assetrenderers.DesktopRectangularShapeRenderer;
...
public class DesktopAssetRendererModule extends AbstractModule implements MapProvider<Class<?>, GraphicRenderer<?, ?>> {
	...
	public DesktopAssetRendererModule(Injector injector) {
		...
		factoryMap.put(RuntimeRectangleShape.class, injector.getInstance(DesktopRectangularShapeRenderer.class));
		factoryMap.put(DesktopEngineIrregularShape.class, injector.getInstance(DesktopIrregularShapeRenderer.class));
