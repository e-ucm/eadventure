...
public class DesktopActionsHUDImpl extends ActionsHUDImpl {
	...
	@Inject
	public DesktopActionsHUDImpl(GUI gui, GameObjectManager gameObjectManager,
			GameState gameState, SceneElementGOFactory sceneElementFactory) {
		super(gui, gameObjectManager, gameState, sceneElementFactory);
		actionGOs = new ArrayList<DrawableGO<?>>();
		this.gameObjectFactory = sceneElementFactory;
