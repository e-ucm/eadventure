...
public class DesktopEngineSpriteImage extends RuntimeSpriteImage<Graphics2D> {
	...
	public BufferedImage getImage() {
		return ((DesktopEngineImage) assetHandler.getRuntimeAsset(descriptor
				.getImage())).getImage();
	}
	...
	public void render(GenericCanvas<Graphics2D> canvas) {
		...
		canvas.getNativeGraphicContext().drawImage(getImage(), 0, 0,
				spriteWidth, spriteHeight, x, y, x + spriteWidth,
				y + spriteHeight, null);
	}
