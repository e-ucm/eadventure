 ...
 * information of an actor in a particular scene.
 */
public interface EAdActorReference extends EAdSceneElement {
	
	/**
	 * Gets the actor that this actor reference points to.
	 * 
