 ...
 */
public interface EAdStateDrawable extends EAdDrawable {

	/**
	 * Returns a {@link EAdDrawable} for a given state state.
	 * 
	 * @param stateName
	 *            Sate name for the animation
	 * @return a {@link EAdDrawable} for a given state state.
	 */
	EAdDrawable getDrawable(String stateName);
