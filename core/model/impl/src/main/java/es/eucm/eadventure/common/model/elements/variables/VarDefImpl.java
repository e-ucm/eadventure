...
@Element(detailed = VarDefImpl.class, runtime = VarDefImpl.class)
public class VarDefImpl<T> implements EAdVarDef<T> {
	 ...
	 */
	public VarDefImpl(String name, Class<T> type, T initialValue) {
	...
	public boolean equals( Object o ){
		if ( o != null && o instanceof VarDefImpl ){
			VarDefImpl<?> var = (VarDefImpl<?>) o;
