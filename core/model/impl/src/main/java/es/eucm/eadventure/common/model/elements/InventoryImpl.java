...
@Element(detailed = InventoryImpl.class, runtime = InventoryImpl.class)
public class InventoryImpl extends EAdElementImpl implements EAdInventory {

	public static final EAdVarDef<Boolean> VAR_IN_INVENTORY = new VarDefImpl<Boolean>(
