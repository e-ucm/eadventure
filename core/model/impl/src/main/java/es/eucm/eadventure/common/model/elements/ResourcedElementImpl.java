 ...
 */
public abstract class ResourcedElementImpl extends AbstractElementWithBehavior implements
		Resourced {
	
	public static final EAdVarDef<EAdBundleId> VAR_BUNDLE_ID = new VarDefImpl<EAdBundleId>(
