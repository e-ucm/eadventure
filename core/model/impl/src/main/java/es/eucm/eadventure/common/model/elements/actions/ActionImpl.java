...
package es.eucm.eadventure.common.model.elements.actions;
...
@Element(runtime = ActionImpl.class, detailed = ActionImpl.class)
public class ActionImpl extends ResourcedElementImpl implements EAdAction {
	...
	public ActionImpl(EAdString name) {
		super();
