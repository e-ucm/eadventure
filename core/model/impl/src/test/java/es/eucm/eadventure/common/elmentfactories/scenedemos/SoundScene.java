...
public class SoundScene extends EmptyScene {
	...
	public SoundScene( ){
		CaptionImpl caption = EAdElementsFactory.getInstance().getCaptionFactory().createCaption("Play", EAdBorderedColor.WHITE_ON_BLACK, EAdBorderedColor.BLACK_ON_WHITE, new EAdFont( new EAdURIImpl( "@binary/DroidSans-Bold.ttf"), 20));
