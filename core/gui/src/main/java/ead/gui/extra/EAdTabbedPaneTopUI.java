...
public class EAdTabbedPaneTopUI extends BasicTabbedPaneUI implements FocusListener, ChangeListener, PropertyChangeListener
{
	private int leftTab =  Integer.MAX_VALUE;
	
	private int rightTab = 0;
