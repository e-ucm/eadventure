...
public class EAdGUILookAndFeel extends BasicLookAndFeel {
    ...
    static {
    	...
    	try {
		    InputStream is = ClassLoader.getSystemResourceAsStream("DroidSans.ttf");
		    Font font = Font.createFont(Font.TRUETYPE_FONT, is);
		    font = font.deriveFont( 12.0f );
		
			UIManager.put("javax.swing.plaf.FontUIResource", new FontUIResource(font));
			
			UIManager.setLookAndFeel("es.eucm.eadventure.gui.EAdGUILookAndFeel");
    ...
    protected void initClassDefaults(UIDefaults table) {
    	...
    	final String eadPackageName = "es.eucm.eadventure.gui.extra.";
    	
    	Object[] uiDefaults = { "ButtonUI", eadPackageName + "EAdButtonUI",
    			"CheckBoxUI", eadPackageName + "EAdCheckBoxUI",
    			"ComboBoxUI", eadPackageName + "EAdComboBoxUI",
    			...
    			"SplitPaneUI", eadPackageName + "EAdSplitPaneUI",
    			"TabbedPaneUI", eadPackageName + "EAdTabbedPaneUI",
    			"TextFieldUI", basicPackageName + "BasicTextFieldUI",
    			"ToggleButtonUI", eadPackageName + "EAdToggleButtonUI",
