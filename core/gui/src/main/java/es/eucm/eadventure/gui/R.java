 ...
 * paramenters: "/Users/eugenio/Documents/eAdWorkspace/eAd2_5/core/gui es.eucm.eadventure.gui.R"
 * where "/Users/eugenio/Documents/eAdWorkspace/eAd2_5/core/gui" is the project location
 * and "es.eucm.eadventure.gui.R" is the name of the package
...
public class R {
	public static class Drawable {
		...
		public static String move_down_png;
		public static String move_up_png;
		public static String redo_png;
		public static String box_empty_png;
		...
		static {
			...
			files.add("add.png");
			files.add("move_down.png");
			files.add("move_up.png");
			files.add("redo.png");
			files.add("box_empty.png");
