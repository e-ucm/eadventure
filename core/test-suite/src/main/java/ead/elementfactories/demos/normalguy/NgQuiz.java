...
public class NgQuiz extends EmptyScene {
	...
	private SceneElement createQuestions() {
	  	...
	  	SceneElement element = EAdElementsFactory.getInstance()
				...
				.createSceneElement(intro, 10, 10);
		...
		StringFactory stringFactory = EAdElementsFactory.getInstance().getStringFactory();
		
		ShowQuestionEf effect = new ShowQuestionEf();
		stringFactory.setString(effect.getQuestion(), q);
		
		effect.addAnswer(stringFactory.getString(a1), getAnswer1(true, stringFactory));
		effect.addAnswer(stringFactory.getString(a2), getAnswer1(false, stringFactory));
		effect.addAnswer(stringFactory.getString(a3), getAnswer1(false, stringFactory));
	...
	private ShowQuestionEf getAnswer1(boolean isCorrect, StringFactory stringFactory) {
		...
		effect.addAnswer(stringFactory.getString(b1), getAnswer2(false, stringFactory));
		effect.addAnswer(stringFactory.getString(b2), getAnswer2(true, stringFactory));
		effect.addAnswer(stringFactory.getString(b3), getAnswer2(false, stringFactory));
	...
	private ShowQuestionEf getAnswer2(boolean isCorrect, StringFactory stringFactory) {
		...
		effect.addAnswer(stringFactory.getString(b1), getAnswer3andClose(false, stringFactory));
		effect.addAnswer(stringFactory.getString(b2), getAnswer3andClose(false, stringFactory));
		effect.addAnswer(stringFactory.getString(b3), getAnswer3andClose(true, stringFactory));
	...
	private ShowQuestionEf getAnswer3andClose(boolean result, StringFactory stringFactory) {
		String questionOk = "Well... I think you are kinda clever but this one will be your end! pregunta número tres";
		String questionWr = "Hehehe... I'm afraid you are wrong!!! hahaha! veamos la tercera";
