...
public class GenerateObjectEffectImporter extends
		EffectImporter<GenerateObjectEffect, Effect> {
	...
	@Override
	public Effect init(GenerateObjectEffect oldObject) {
		Effect effect = new ModifyInventoryEf();
		return effect;
	}

	@Override
	public Effect convert(GenerateObjectEffect oldObject, Object object) {
