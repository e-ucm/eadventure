...
public class CancelActionEffectImporter extends
		EffectImporter<CancelActionEffect, Effect> {
	...
	@Override
	public Effect init(CancelActionEffect oldObject) {
		return null;
	}

	@Override
	public Effect convert(CancelActionEffect oldObject, Object object) {
		return null;
	}
