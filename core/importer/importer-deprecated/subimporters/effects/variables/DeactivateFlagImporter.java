...
public class DeactivateFlagImporter extends
		EffectImporter<DeactivateEffect, ChangeFieldEf> {
	...
	@Override
	public ChangeFieldEf init(DeactivateEffect oldObject) {
		EAdField<?> var = factory
				.getVarByOldId(
						oldObject.getTargetId(),
						es.eucm.eadventure.common.data.chapter.conditions.Condition.FLAG_CONDITION);
