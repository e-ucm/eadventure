...
public class MacroImporter {
	...
	//	@Override
	//	public EAdList<Effect> init(Macro oldMacro) {
	//		EAdList<Effect> macro = new EAdList<Effect>();
	//		return macro;
	//	}
	//
	//	@Override
	//	public EAdList<Effect> convert(Macro oldMacro, Object object) {
	//		EAdList<Effect> newMacro = (EAdList<Effect>) object;
	//
	//		for (Effect e : oldMacro.getEffects()) {
	//			Effect newEffect = (Effect) effectImporter.getEffect(e);
