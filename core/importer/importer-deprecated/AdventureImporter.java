...
public class AdventureImporter {
	...
	public AdventureImporter() {
		...
		importer = injector.getInstance(EAdventureImporter.class);
	}

	/**
	 * Imports the game in a temporal folder
	 * @param f the file with the game
	 * @return The path to the temporal folder
	 */
	public String importInTemp(String f) {
		importer.importGame(f, null);
		return importer.getDestinationFile();
	}
