...
public class PlayNEngineSpriteImage extends RuntimeSpriteImage<Canvas> {
	...
	public Image getImage() {
		return ((PlayNEngineImage) assetHandler.getRuntimeAsset(descriptor
				.getImage())).getImage();
	}
	...
	public void render(GenericCanvas<Canvas> c) {
		...
		c.getNativeGraphicContext().drawImage(getImage(), 0, 0, spriteWidth,
				spriteHeight, x, y, x + spriteWidth, y + spriteHeight);
	}
