...
@Singleton
public class PlayNComposedDrawableRenderer implements AssetRenderer<Canvas, RuntimeComposedDrawable> {

	/**
	 * Logger
	 */
	private static final Logger logger = Logger.getLogger("PlayNComposedDrawableRenderer");
