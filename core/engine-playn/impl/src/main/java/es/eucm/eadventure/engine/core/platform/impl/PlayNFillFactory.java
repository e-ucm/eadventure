...
@Singleton
public class PlayNFillFactory implements FillFactory<SurfaceLayer, Shape> {

	private Paint paint;

	@Override
	public void fill(EAdFill fill, SurfaceLayer graphicContext, Shape shape) {
	...
	@Override
	public void fill(EAdFill fill, SurfaceLayer graphicContext, String text) {
		Graphics2D g2 = (Graphics2D) graphicContext.create();
		if (fill instanceof EAdColor) {
			prepareGraphics((EAdColor) fill, g2);
	...
	private void prepareGraphics(EAdColor color, SurfaceLayer g2) {
