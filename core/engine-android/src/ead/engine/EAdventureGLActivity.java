...
import ead.engine.core.platform.AndroidInputListener;
import ead.engine.core.platform.assets.AssetHandler;
import ead.engine.core.platform.modules.BasicGameModule;
import ead.engine.gl.EAdRenderer;
import ead.engine.gl.GLAssetHandler;
import ead.engine.gl.GLAssetHandlerModule;
import ead.engine.gl.GLCanvas;
import ead.engine.gl.GLGUI;
import ead.engine.gl.GLModule;
...
public class EAdventureGLActivity extends Activity {
	...
	private void initInjector() {
		injector = Guice.createInjector(new BasicGameModule(), new GLModule(),
