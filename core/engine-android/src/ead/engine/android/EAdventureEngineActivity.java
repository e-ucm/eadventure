...
import ead.engine.android.core.platform.assets.specialassetrenderers.RockPlayerAndroidVideoRenderer;
import ead.engine.android.core.platform.extra.EAdventureSurfaceView;
import ead.engine.android.core.platform.modules.AndroidAssetHandlerModule;
import ead.engine.android.core.platform.modules.AndroidModule;
...
public class EAdventureEngineActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		injector = Guice.createInjector(new AndroidAssetHandlerModule(),
				new AndroidModule(), new JavaBasicGameModule());
