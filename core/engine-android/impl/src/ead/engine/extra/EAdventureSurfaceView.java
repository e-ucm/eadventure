...
public class EAdventureSurfaceView extends SurfaceView implements
	...
	private class EAdventureGestureListener extends SimpleOnGestureListener {
		...
		public boolean onDown(MotionEvent e) {
			inputHandler.addAction(new MouseActionImpl(
					MouseGEv.MOUSE_LEFT_PRESSED, (int) e.getX(), (int) e
							.getY()));
			return true;
		}
		...
		public void onLongPress(MotionEvent e) {
			...
			inputHandler.addAction(new MouseActionImpl(
					MouseGEv.MOUSE_RIGHT_CLICK, (int) e.getX(), (int) e
							.getY()));
			MouseActionImpl action = new MouseActionImpl(MouseGEvType.CLICK,
		...
		public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX,
			...
			inputHandler.addAction(new MouseActionImpl(
					MouseGEv.MOUSE_LEFT_RELEASED, (int) e2.getX(),
					(int) e2.getY()));
			return true;
		}
	}
	...
	private class OnTouchListener implements View.OnTouchListener {
		...
		public boolean onTouch(View v, MotionEvent event) {
			...
			inputHandler.addAction(new MouseActionImpl(MouseGEv.MOUSE_MOVED,
					x, y));
