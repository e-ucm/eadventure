...
/**
 * Represents the placement of an {@link es.eucm.ead.model.weev.Actor} in a {@link Space}
 * 
 */
public interface ActorPlacement extends WorldElement, Positioned {
	...
	/**
	 * @return the {@link es.eucm.ead.model.weev.Actor} that is placed by this placement
	 */
	Actor getActor();
